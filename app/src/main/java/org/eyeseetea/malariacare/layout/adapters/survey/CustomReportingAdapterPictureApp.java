 ...
 */
public class CustomReportingAdapterPictureApp extends BaseAdapter implements ITabAdapter {
    ...
    public CustomReportingAdapterPictureApp(List<Object> items, Context context, int id_layout, String tabName) {
    ...
    private void textEntered(CustomTextView score, RowValues rowValues) {
