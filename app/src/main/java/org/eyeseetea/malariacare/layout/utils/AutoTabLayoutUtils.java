...
public class AutoTabLayoutUtils {
    ...
    /**
     * Recalculate num and denum of a quetsion, update them in cache vars and saveOldSurvey the new num/denum in the score register associated with the question
