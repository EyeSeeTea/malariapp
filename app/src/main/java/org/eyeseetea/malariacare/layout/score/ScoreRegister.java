...
public class ScoreRegister {
    ...
    public static void addQuestionRowRecords(QuestionRow questionRow, float surveyId){
        for(Question question:questionRow.getQuestions()){
            ScoreRegister.addRecord(question, 0F, ScoreRegister.calcDenum(question), surveyId);
        }
