...
public class Constants {
    ...
    public static final int MINIMAL_WIDTH_PIXEL_RESOLUTION_TO_SHOW_LARGE_TEXT = 240;
    public static final int MINIMAL_HEIGHT_PIXEL_RESOLUTION_TO_SHOW_LARGE_TEXT = 320;
}
