...
public class ActionBarStrategy extends LayoutUtils {
    ...
    protected static void setActionbarTitle(ActionBarActivity activity, Spanned title, Spanned subtitle,
        ...
        ((TextView) activity.findViewById(R.id.action_bar_multititle_title)).setText(title);
        ((TextView) activity.findViewById(R.id.action_bar_multititle_subtitle)).setText(subtitle);
        ((TextView) activity.findViewById(R.id.action_bar_user)).setText(user);
