...
public class SurveyChecksEspressoTest extends MalariaEspressoTest{
    ...
    private static Survey clinicalSurvey;
...
//        mockSessionSurvey(2, 0);
        ...
        clinicalSurvey=mockSessionSurvey(1,0,1);//1 Clinical Case Management, select this one
    }
    ...
    public void radiobutton_textsize_changes(){
        //GIVEN
        SurveyActivity activity = (SurveyActivity)getActivityInstance();
        Session.setSurvey(icmSurvey);
